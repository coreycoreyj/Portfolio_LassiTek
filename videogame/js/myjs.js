...
(function(){
	...
	function start(){
		...
		$(document).ready(function(){
			...
			var employmentHtml = '<div class="' + textClasses + '">I currently work at <a href="https://www.bellomy.com/" target="_blank">Bellomy Research</a> as a <b>Technical Operations Specialist</b>. I have been there since May 2016 (over 3 years).	Some responsibilities include: <ul>' +
			...
			var endHtml = '<div class="' + textClasses + '"><h2>The End!</h2> Thank you for walking with me through this Mario-like world! I hope you enjoyed. Here are some extra links just in case you would like to view them. Also if you want to jump to different sections of my portfolio, just click on the menu above.<ul>' +
			...
			'<li>My 2018 Javascript skills test results from Robert Half Technology: <a href="pdfs/CL_JavaScript_Test_Result.pdf" target="_blank">CL_JavaScript_Test_Result.pdf</a></li>' +
			'<li>Resume: <a href="pdfs/Corey_L_Resume.pdf" target="_blank">Corey_L_Resume.pdf</a></li>' +
